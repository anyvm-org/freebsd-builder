...
[![Release](https://img.shields.io/github/v/release/anyvm-org/{{VM_OS_NAME}}-builder?include_prereleases&sort=semver&display_name=tag)](https://github.com/anyvm-org/{{VM_OS_NAME}}-builder/releases)
